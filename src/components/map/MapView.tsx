    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
        <div className="h-96 bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center relative">
          <div className="text-center p-8">
            ...
            <h3 className="text-2xl font-bold mb-2" style={{ color: '#0f172a' }}>Interactive Map</h3>
            ...
            <div className="bg-white rounded-lg p-4 text-left max-w-md mx-auto">
              <p className="text-sm mb-2" style={{ color: '#475569' }}>To enable the map:</p>
              <ol className="text-sm space-y-1 list-decimal list-inside" style={{ color: '#1e293b' }}>
            ...
            <div key={`${activity.day}-${index}`} className="flex items-start gap-4 p-4 border border-gray-200 rounded-xl hover:shadow-md transition-shadow">
              ...
              <div className="flex-1">
                <div className="flex items-start justify-between mb-2">
                  <div>
                    <h4 className="font-semibold" style={{ color: '#0f172a' }}>{activity.name}</h4>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="text-sm mb-1" style={{ color: '#64748b' }}>Total Locations</div>
          <div className="text-3xl font-bold text-blue-600">{allActivities.length}</div>
        </div>
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="text-sm mb-1" style={{ color: '#64748b' }}>Cities</div>
          <div className="text-3xl font-bold text-purple-600">
            {new Set(allActivities.map((a) => a.location.city)).size}
          </div>
        </div>
        <div className="bg-white rounded-xl p-6 shadow-sm">
          <div className="text-sm mb-1" style={{ color: '#64748b' }}>Estimated Travel Time</div>
